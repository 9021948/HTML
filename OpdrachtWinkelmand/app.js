...
// Opdracht 1 Tel met de eigenschap length hoeveel producten er in de variabel winkelmandje 
...
document.getElementById('opdracht3').innerHTML = 'Het 4e product zijn: ' + winkelmandje[3];
...
document.getElementById("opdracht 7").innerHTML = "<p>U heeft drop</p>";
} else {
